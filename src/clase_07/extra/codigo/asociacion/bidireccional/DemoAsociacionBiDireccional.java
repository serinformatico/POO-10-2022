...
public class DemoAsociacionBiDireccional {
    ...
    public static void main(String[] args) {
        ...
        perros[0].setAmo(persona);
        perros[1].setAmo(persona);

        // La relación inversa; me permite preguntarle a un perro quien es su amo
